...
var selectedsubject = '';
var startselectedcomparison = '';
var start_time = '';
var endselectedcomparison = '';
var end_time = '';
var selectedgrouping = '';
var instructor_lastname = '';
var selectedcampus = '';
var selectedinstructionmethod = '';
...
checkboxes.addEventListener('change', function(e) {
    ...
    if (e.target.checked) {
        // Checkbox is checked
        console.log(e.target.name + ' checkbox is checked');
    } else {
        // Checkbox is not checked
        console.log(e.target.name + ' checkbox is not checked');
    }
    */
});

const form = document.getElementById('course-search'); // Get the form element
